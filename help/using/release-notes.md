...
description: De details, de verhogingen van de versie, nieuwe eigenschappen, verenigbaarheid, en downloadverbindingen voor  [!DNL Adobe Experience Manager]  App van de Desktop.
mini-toc-levels: 1
...
# [!DNL Adobe Experience Manager] Opmerkingen bij de release Desktop App {#release-notes-v2}

Deze release van desktop app versie 3.0.2 bevat foutoplossingen om de algemene stabiliteit en prestaties van de toepassing te verbeteren.
...
|---|---|---|
| macOS (v3.0.2) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-osx-x64-3.0.2.dmg) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-osx-x64-3.0.2.dmg) |
| macOS Apple Silicon (M1) (v3.0.2) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-osx-arm64-3.0.2.dmg) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-osx-arm64-3.0.2.dmg) |
| Windows 64-bits (v3.0.2) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-win-x64-3.0.2.exe) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-win-x64-3.0.2.exe) |
| Windows 64-bits Enterprise (v3.0.2) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-win-x64-ent-3.0.2.msi) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-win-x64-ent-3.0.2.msi) |
| macOS (v3.0.1) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-osx-x64-3.0.1.dmg) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-osx-x64-3.0.1.dmg) |
| macOS Apple Silicon (M1) (v3.0.1) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-osx-arm64-3.0.1.dmg) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-osx-arm64-3.0.1.dmg) |
| Windows 64-bits (v3.0.1) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-win-x64-3.0.1.exe) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-win-x64-3.0.1.exe) |
| Windows 64-bits Enterprise (v3.0.1) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aemcloud.html?package=/content/software-distribution/en/details.html/content/dam/aemcloud/public/aem-desktop-app/aem-desktop-win-x64-ent-3.0.1.msi) | [ Verbinding van de Download ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/adobe/aem-desktop-app/aem-desktop-win-x64-ent-3.0.1.msi) |
...
Om de details te kennen, zie [ wat in v3.0.2 ](introduction.md#whats-new-v2) nieuw is.

### Updates in app v3.0.1 {#app-version-3.0.1}

De release van desktop app versie 3.0.1 bevat de volgende verbeteringen:

**Vloeiender en betrouwbaardere werkschema&#39;s**

* Zorgt voor consistente mapnaamgeving door synchronisatieproblemen tussen de AEM Desktop App en de AEM Author te verhelpen.
* Ononderbroken workflows ingeschakeld door volledige toepassingsfunctionaliteit toe te staan tijdens actieve overdrachtsbewerkingen.
* Verbeterde betrouwbaarheid van de pagina met eigenschappen van de map, waardoor consistente toegang tot metagegevens en instellingen van de map mogelijk is.

**Sneller en ontvankelijkere gebruikerservaring**

* Verbeterde reactiesnelheid van de gebruikersinterface door het blokkeren van I/O te vervangen door asynchrone verwerking, waardoor een vlottere ervaring wordt geboden tijdens bewerkingen met hoge belasting.
* Verbeterde grote dossieroverdrachten door paginering in upload en downloadstromen te introduceren, toelatend efficiënte behandeling van grote datasets.

**Betere stabiliteit en betrouwbaarheid**

* Opgeloste serveropnieuw opstarten van Auteur geactiveerd door interactie van Desktop App, wat de systeemstabiliteit aanzienlijk verbetert.
* De toepassing waarvoor het probleem is opgelost, loopt vast tijdens het downloaden of uploaden van grote mappen (duizenden bestanden).

### Updates in app v3.0.0 {#app-version-3.0.0}

Deze release biedt meerdere verbeteringen voor verzamelingen, uploads, inchecken/uitchecken, metagegevensbeheer en algemene bruikbaarheid. Deze updates verbeteren de efficiëntie, stroomlijnen de verwerking van bedrijfsmiddelen en bieden een intuïtievere, real-time ervaring in de AEM Desktop App.
...
* De Desktop App reageert niet meer wanneer u bestanden uploadt in een map die Chinese tekens bevat (ASSETS-9237).
...
* Gebruikers kunnen nu de bestanden of mappen op de interface van de toepassing slepen, rechtstreeks vanuit Windows Verkenner of Mac Finder. Dit proces werkt naast de uploadoptie die beschikbaar is in de toepassing. Zie [ activa ](/help/using/upload-assets.md#upload-and-add-new-assets-to-aem) uploaden <!-- CQ-4309527 -->
