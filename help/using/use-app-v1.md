...
Deze integratie maakt gecentraliseerd beheer van bedrijfsmiddelen en toegang voor Creative Cloud en andere toepassingen mogelijk en zorgt ervoor dat aan de standaarden voor branding en andere standaarden wordt voldaan.
...
Zorg ervoor dat de toepassing uw versie van de Experience Manager-server ondersteunt om de Experience Manager-bureaubladtoepassing te gebruiken. Download het juiste (binaire) installatiebestand voor uw besturingssysteem (Mac of Windows) en installeer de toepassing.
...
>[!NOTE]
>
>Adobe adviseert dat u naar de Opties van de Mening van de Vinder op Mac gaat en de opties **desactiveert tonen puntinfo**, **toont puntvoorproef**, en **toont voorproefkolom** voor de opgezette [!DNL Assets] omslag. Het verbetert de prestaties.
...
Adobe raadt u niet aan een groter aantal bestanden of geneste mappen vanuit het lokale bestandssysteem naar het gedeelde netwerkgebied te kopiëren of te plakken. De toepassing kan het uploadproces niet beheren vanwege technische beperkingen en de prestaties zijn slecht.
